...
| observability | 10.10.10.112 | Portainer, Prometheus, Grafana, Loki, Alloy, Homarr |
...
2. **observability VM:** Portainer → Prometheus → Grafana → Loki → Alloy → Homarr
...
### Layer 1: Homarr Dashboard (Primary Entry Point)
- **URL:** https://home.onurx.com
